...
var triggerSchema = objectType({
  name: stringType(),
  schema: stringType(),
  tableName: stringType(),
  definition: stringType()
}).strict();
var procedureSchema = objectType({
  name: stringType(),
  schema: stringType(),
  definition: stringType()
}).strict();
...
var pgSchemaInternal = objectType({
  ...
  policies: recordType(stringType(), policy2).default({}),
  functions: recordType(stringType(), functionSchema).default({}),
  triggers: recordType(stringType(), triggerSchema).default({}),
  procedures: recordType(stringType(), procedureSchema).default({}),
  _meta: objectType({
    schemas: recordType(stringType(), stringType()),
    tables: recordType(stringType(), stringType()),
    columns: recordType(stringType(), stringType())
